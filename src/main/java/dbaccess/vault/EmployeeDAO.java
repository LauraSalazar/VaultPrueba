...
public class EmployeeDAO extends GenericDAO {
	...
	public List<Employee> getEmpleadosByJobId(Integer id){
		...
		String query = "select c.firstName,c.lastName,c.email,c.phoneNumber,c.hireDate,c.job,c.salary,c.commissionPct,c.department,c.jobHistories from EMPLOYEES c"; 
