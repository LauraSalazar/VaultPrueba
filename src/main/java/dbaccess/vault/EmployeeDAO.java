...
public class EmployeeDAO extends GenericDAO {
	...
	public List<EmployeePersist> getEmpleadosByJobId(Integer id){
		...
		String query = "select new model.EmployeePersist( c.firstName,  c.lastName,  c.email,  c.phoneNumber,  c.hireDate, c.job, c.salary, c.commissionPct,  c.department) from EMPLOYEES c"; 
